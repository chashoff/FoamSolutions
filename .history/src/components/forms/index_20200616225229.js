...
const Form = () => (
    <form className="form-container">
        ...
        <h6 style={{textAlign: 'center', fontWeight: '400', borderBottom: '1px solid lightgrey', paddingBottom: '1em'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</h6>
        <div className="flex">
            <p>Your first name...</p>
