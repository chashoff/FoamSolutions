...
const Form = () => (
    <form className="form-container">
        ...
        <p style={{textAlign: 'center', fontWeight: '400', borderBottom: '1px solid lightgrey', paddingBottom: '1em'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</p>
        <div className="flex">
            <p>Your first name...</p>
