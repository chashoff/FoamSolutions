                ...
                return (
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div className="blur-container section">
                            <h2 style={{ marginTop: '3em'}} className="section-one-header-slide-one">About Our Company</h2>
                            <div>
                                <div style={{display: 'flex', flexDirection: 'column', width: '80%' , margin: '0 auto', paddingBottom: '1em', marginTop: '1em'}}>
                                ...
                                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '1em', marginTop: '.5em', justifyContent: 'space-between', flexWrap: 'wrap'}}>
                                    <div className="about-info-container" style={{width: '65%', margin: 'auto 0', backgroundColor: 'rgba(229, 229, 229, .72)', height: '100%',  padding: '2em'}}>
                                    ...
                                    <div className="about-info-container" style={{width: '65%', backgroundColor: 'rgba(229, 229, 229, .72)', padding: '2em'}}>
