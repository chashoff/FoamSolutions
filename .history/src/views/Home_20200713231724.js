                    ...
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div className="section gradient-one">
                            ...
                            <div className="slide blur-container section-container">
                                ...
                                <div>
                                    <div className="about-info-container" style={{display: 'flex', flexDirection: 'column', width: '60%', alignContent: 'center', alignItems: 'center', justifyContent: 'center', margin: '0 auto'}}>
