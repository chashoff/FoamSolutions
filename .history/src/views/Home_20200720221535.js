                    ...
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div id="location" className="section">
                            <div className="locationContainer" style={{display: 'flex'}}>
                                <Map />
                                <div style={{ maxWidth: '50%', padding: '2em', backgroundColor: 'transparent'}}>
                                    <div className="locationService" style={{ backgroundColor: 'white', padding: '.5em 1em', borderLeft: '10px solid lightgreen'}}>
                                        ...
                                        <p style={{textAlign: 'center'}}>We take pride in our ability to service all of North America, and a majority of Latin America. With partners around the globe! Where ever you are we can get on track to being 100% compliant!</p>
                                    </div>
                                </div>
                            </div>
                        </div>
