                        ...
                        <div id="testimonials" className="section">
                                ...
                                <div className="testimonial-container">
                                    <div className="testimonial">
                                        ...
                                        <div>
                                            <img style={{ borderRadius: '50%'}} src="/images/user-sean.png" alt=""/>
                                            <div>
                                    ...
                                    <div className="testimonial">
                                        ...
                                        <div>
                                            <img style={{ borderRadius: '50%'}} src="/images/user-3.png" alt=""/>
                                            <div>
                                    ...
                                    <div className="testimonial">
                                        ...
                                        <div>
                                            <img style={{ borderRadius: '50%', height: '100px'}} src="/images/user-ricky.png" alt=""/>
                                            <div>
