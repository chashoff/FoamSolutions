                        ...
                        <div className="section gradient-one">
                            ...
                            <div className="slide blur-container section-container">
                                ...
                                <div>
                                    ...
                                    <div style={{display: 'flex', padding: '1em', marginTop: '2em', justifyContent: 'space-between', flexWrap: 'wrap'}}>
                                        <div className="about-info-container" style={{width: '40%', margin: 'auto 0', backgroundColor: 'rgba(229, 229, 229, .72)', height: '100%',  padding: '2em'}}>
                                        ...
                                        <div className="about-info-container" style={{width: '40%', backgroundColor: 'rgba(229, 229, 229, .72)', height: '100%', padding: '2em'}}>
                                            <h2 style={{color: 'ligd, textAlign: 'center'}}>What We Do</h2>
                                            <p className="span-spacing" style={{width: '100px'}}></p>
                                            <div>
