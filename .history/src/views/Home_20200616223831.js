                ...
                return (
                    <div>
                        ...
                        <div className="section background-image-contact">
                            ...
                            <h6 style={{textAlign: 'center', fontWeight: '400', margin: '1em 0', color: 'darkgrey'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</h6>
                            <Form />
                        </div>
                        {/* <div className="section">
                            <h1>NFPA</h1>
