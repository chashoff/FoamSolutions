                ...
                return (
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column'}} className="section">
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '3em', height: '360px' }}>
                                <button className="prev-arrow" onClick={this.prev}>prev</button>
                                <img style={{ height: '360px' }} src={carouselImages[this.state.imageCarousel]} alt="" />
                                <button className="next-arrow" onClick={this.next}>next</button>
                            </div>
                        </div>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column', height: '100vh' }} className="section">
                            ...
                            <div className="created-by" style={{ position: 'relative', marginTop: 'auto', textAlign: 'center', zIndex: '1000', backgroundColor: '#232423', width: '10%', margin: '0 auto' }}>
                                <img style={{height: '50px'}} src="/images/lovast_logo.svg" alt="" />
