                        ...
                        <div className="section gradient-one">
                            ...
                            <div className="slide blur-container section-container">
                                ...
                                <div>
                                    ...
                                    <div style={{display: 'flex', alignItems: 'center', padding: '1em', marginTop: '2em', backgroundColor: '#f0f0f0', justifyContent: 'space-between'}}>
                                        <div style={{width: '40%'}}>
                                            <h5 className="working-date">Working Since 2006</h5>
                                            <p className="span-spacing"></p>
                                            <p className="exp-text-slide-one">Our company offers the most cost effective, environmentally friendly solution to your annual foam proportioner testing. Proudly servering our </p>
                                        </div>
                                        <div style={{width: '40%'}}>
