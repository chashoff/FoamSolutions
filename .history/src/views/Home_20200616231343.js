...
class Home extends Component {    
    render() {
        ...
        return (
            ...
            <p style={{textAlign: 'center', fontWeight: '400', borderBottom: '1px solid lightgrey', paddingBottom: '1em', fontSize: '.8em'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</p>
                            <Form />
                        </div>
                        {/* <div className="section">
                            <h1>NFPA</h1>
