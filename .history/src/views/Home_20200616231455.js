                ...
                return (
                    <div>
                        ...
                        <div className="section background-image-contact">
                            ...
                            <p style={{textAlign: 'center', fontWeight: '400', paddingBottom: '4em', fontSize: '.8em'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</p>
                            <Form />
                        </div>
                        {/* <div className="section">
                            <h1>NFPA</h1>
