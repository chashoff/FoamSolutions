                        ...
                        <div className="section gradient-one">
                            <div className="slide section-container">
                                ...
                                <div>
                                    ...
                                    <div>
                                        <h5 style={{ textAlign: 'center'}}>Our Process</h5>
                                        <ReactPlayer style={{ margin: '0 auto'}} loop="true" playing="true" url='https://www.youtube.com/watch?time_continue=1&v=j6n8v_guPy0&feature=emb_logo' />
                                    </div>
                                </div>
                            </div>
                            <div className="slide">
