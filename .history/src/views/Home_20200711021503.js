                        ...
                        <div className="section gradient-one">
                            ...
                            <div className="slide blur-container section-container">
                                ...
                                <div>
                                    ...
                                    <div style={{display: 'flex', padding: '1em', marginTop: '2em', justifyContent: 'space-between', padding: '2em'}}>
                                        <div style={{width: '40%', margin: 'auto 0', backgroundColor: '#fafafa', height: '100%'}}>
