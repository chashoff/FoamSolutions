                ...
                return (
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div className="blur-container section">
                            ...
                            <div>
                                <div style={{display: 'flex', flexDirection: 'column', width: '60%', backgroundColor: 'rgba(229, 229, 229, .72)' , margin: '0 auto', paddingBottom: '1em', marginTop: '1em'}}>
                                    <h5 style={{ textAlign: 'center', marginTop: '.5em'}}>Our Process</h5>
                                    <p className="span-spacing" style={{width: '100px'}}></p>
                                    <ReactPlayer style={{ margin: '0 auto', width: '400px !Important'}} loop="true" playing="false" url='https://www.youtube.com/watch?time_continue=1&v=j6n8v_guPy0&feature=emb_logo' />
                                </div>
