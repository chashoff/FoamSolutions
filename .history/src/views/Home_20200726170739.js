...
import AwesomeSlider from 'react-awesome-slider';import AutoplaySlider from 'react-awesome-slider/hoc/autoplay';
                ...
                return (
                    <div style={{ overflowY: 'hidden', padding: '0', margin: '0'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column'}} className="section">
                            ...
                            <AutoplaySlider style={{height: '400px', width: '40%', margin: '3em auto'}}
                                play={true}
