            ...
            <>
                ...
                return (
                    <div>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row '}} className="section background-image-contact">
                            <h3 style={{ textAlign: 'center', fontWeight: '500', color: 'lightgrey'}}>Contact our sales team</h3>
                            <h6 style={{textAlign: 'center', fontWeight: '400', margin: '1em 0', color: 'black'}}>Our team is happy to answer your questions. The only bad question is the one not asked!</h6>
                            <Form />
                        </div>
                        {/* <div className="section">
                            <h1>NFPA</h1>
