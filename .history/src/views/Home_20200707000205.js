                    ...
                    <div style={{ overflowY: 'hidden'}}>
                        ...
                        <div className="section gradient-one">
                            <div id="about" className="slide section-container">
                                ...
                                <h2>What We Do</h2>
                                <div>
                                    <p>The method relies on an initial foam system discharge test to establish that the system is working properly and to determine the concentration the proportioner is developing. This test is conducted in the same fashion as any other foam proportioning system acceptance test. This test is immediately followed by a water equivalency test at the exact same conditions as the initial foam discharge test.</p>
                                </div>
                            </div>
