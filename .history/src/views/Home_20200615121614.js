...
import image from '../images/bg43.jpg'
AOS.init();
...
class Home extends Component {
    ...
    render() {
        ...
        const logo = '/images/stacked_logo.svg'
                ...
                <WaterWave
                    ...
                    {methods => (
                        ...
                        <FadeIn>
                            ...
                            <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', marginTop: 'auto',overflowX: 'hidden' }}> <NavBar />
                                <div style={styles.container}>
                                    <div style={styles.heroContainer}>
                                        <img style={{ height: '200px' }} src={logo} alt="Company logo" />
                                        <h4 style={{ paddingTop: '.25em', fontSize: '1em', color: '#333333' }}>Foam Proportioner Testing for <span style={styles.label}>HEF</span>, <span style={styles.label}>AR</span> and <span style={styles.label}>AFFF</span> Systems</h4>
                                        <p style={{ fontSize: '1.6em', marginTop: '.75em', color: '#333333' }}>
