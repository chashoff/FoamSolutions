                            ...
                            <div className="locationContainer" style={{display: 'flex'}}>
                                ...
                                <div style={{ maxWidth: '50%', padding: '2em', backgroundColor: 'transparent'}}>
                                    ...
                                    <div className="locationService" style={{ marginTop: '2em', backgroundColor: 'white', padding: '.5em 1em', borderLeft: '10px solid #ff7878'}}>
                                        ...
                                        <p style={{textAlign: 'center', fontSize: '1.2em'}}>Check out our partners at <strong><a class="partner-link" href="https://www.industrialservices.ec/">Industrial Services!</a></strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
